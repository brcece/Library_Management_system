    ...
    public partial class LIBRARIAN : Form
    {
        ...
        private void form_button_logın_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = "select * from userTable where username = '" + form1_textbox_username.Text + "' and pass ='" + form1_textBox_password.Text + "' and roleid =" + 3 + " or roleid=" + 1 ;
                ...
                if (ds.Tables[0].Rows.Count != 0)
                {
                    ...
                    DashboradL dash = new DashboradL();
                    dash.Show();
                    this.Hide();
